...
class HomePage extends StatefulWidget {
  const HomePage({Key? key, required this.title, required this.label})
      : super(key: key);
...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
  ...
  final boxRowCount = 2;
  final boxColumnCount = 3;

  final List<List<GameBoxModel>> _gameBoxModelMatrix = [];
  final List<GameBoxModel> _openedCouple = [];
  ...
  */
  ...
  /*
  ** Change game box animation status and duration and play.matrix
  */
