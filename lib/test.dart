...
class NoHint extends StatefulWidget {
  const NoHint({Key? key, required this.title, required this.label})
      : super(key: key);
  ...
  @override
  State<NoHint> createState() => _NoHintState();
}

class _NoHintState extends State<NoHint> with TickerProviderStateMixin {
