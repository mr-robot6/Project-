...
class SixByFive extends StatefulWidget {
  const SixByFive({Key? key, required this.title, required this.label})
      : super(key: key);
  ...
  @override
  State<SixByFive> createState() => _SixByFiveState();
}

class _SixByFiveState extends State<SixByFive> with TickerProviderStateMixin {
